...
pyrobot-$(PYROBOT_VERSION).tgz: Makefile
	...
	make clean; cd ..; tar cfz pyrobot-$(PYROBOT_VERSION).tgz --exclude video --exclude usermanual --exclude images --exclude html --exclude fedora --exclude stylesheet.css --exclude knoppix --exclude CVS --exclude tars --exclude download --exclude Makefile.cfg pyrobot; mv pyrobot-$(PYROBOT_VERSION).tgz pyrobot; cd -; mv *.tgz download
